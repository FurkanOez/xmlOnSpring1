...
//dosyayi koyup ardindan dosyadaki tüm dosyalari aliyoruz ve for loop icinde bu filelari almasi icin döndürüyoruz
    ...
    public String saveDataToDb(Set<Attribute> attributes) {
        String result = "";
        Attribute correlationsID = attributes.stream().filter(s -> s.getAttrName().equals("CorrelationsID")).findFirst().get();
    ...
    public List<Attribute> searchByKey(String key, String value) {
